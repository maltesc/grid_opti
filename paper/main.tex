...
\author{Malte Scharf}
\date{\today}
\title{Modelling and Optimization Final Excecise}
\subtitle{Simple Grid Optimization}
...
%\input{append/categories.tex}

%\input{formal/erklaerung.txt}
